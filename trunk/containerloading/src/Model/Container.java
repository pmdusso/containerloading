...
public class Container {
	...
	// Se a ultima caixa colocada "encheu" o eixo Y, passa para a proxima
	// linha.
	if (lastBoxInserted.x == this.x) {

	    lastBoxInserted = new Vector3d(0, lastBoxInserted.y + _box.relativeDimensions.y, lastBoxInserted.z);
	}
	// Se a ultima caixa colocada "encheu" o eixo X, passa para a linha de
	// cima.
    ...
    public Box fitsIn(Box box) {
	return fitsIn(box, new Vector3d(0, 0, 0));
    }
}
